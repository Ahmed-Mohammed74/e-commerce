...
const ResetPassword = () => {
  ...
  const resetPassword = async (values) => {
    try {
      ...
      // استبدل الرابط ده برابط API الصحيح
      ...
      setTimeout(() => {
        router.push("/login"); // يرجع للصفحة الرئيسية أو صفحة تسجيل الدخول
      }, 1500);
    } catch (err) {
      setSuccessMsg(null);
    ...
    <div className="container mx-auto mt-10 px-4">
      ...
      >
        <input
          ...
          className="block py-3 px-4 w-full text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 mb-4"
        ...
        {formik.errors.email && formik.touched.email && (
          <div className="p-3 mb-2 text-sm text-white bg-red-500 rounded-lg">
